...
def main():
    print("Welcome to the Product Recommendation System! - task_3.py:29")
    print("Type your search (e.g., soap, mobile, toys, games). Type 'exit' to finish. - task_3.py:30")
    while True:
    ...
    print("Based on your search history, we recommend: - task_3.py:40")
    print(", - task_3.py:41".join(final_recs))
